...
user_pref("urlclassifier.trackingSkipURLs", "*://embed.reddit.com/*,*://*.twitter.com/*,*://*.twimg.com/*, *://youtube.com/*"); // MANUAL [FF136+]
user_pref("urlclassifier.features.socialtracking.skipURLs", "*://*.twitter.com/*,*://*.twimg.com/*, *://youtube.com/*"); // MANUAL [FF136+]

// PREF: restore search engine suggestions
user_pref("browser.search.suggest.enabled", true);

// PREF: allow custom css
user_pref("toolkit.legacyUserProfileCustomizations.stylesheets", true)
